...
\resizebox{\textwidth}{!}{
  ...
  \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{The} & \textbf{} & \textbf\textit{The}  & \textbf{} & \textbf\textit{The} & \textbf\textit{The}\\
  % line 2 of table headers
  \textbf{} & \textbf{BBC} & \textbf{BuzzFeed} & \textbf{CNN} & \textbf{Huffington} & \textbf{Mashable} & \textbf\textit{New York}  & \textbf{VICE} & \textbf\textit{Washington} & \textbf\textit{Wall Street}\\
  % line 3 of table headers
  \textbf{} & \textbf{News} & \textbf{} & \textbf{} & \textbf{Post} & \textbf{} & \textbf\textit{Times}  & \textbf{} & \textbf\textit{Post} & \textbf\textit{Journal}\\
\hline 
Kik& &X& &X& & &X&X& \\
LINE&X&X& & &X& & & &X\\
Skype& & & & & & &X& & \\
